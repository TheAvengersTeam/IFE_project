...
function initGraTimeForm() { 
  var pageRadio = fgt.getElementsByTagName('input'); 
...
function initCitySelector() { 
  ...
  cs.innerHTML = cityList; 
  // 给select设置事件，当选项发生变化时调用函数citySelectChange 
  addEventHandler(cs,'change',citySelectChange) 
} 
...
function initAqiChartData() { 
  ...
  //nowCityData是确定的一个城市的91天降水数组，key是日期，nowCityData[key]是降水量 
